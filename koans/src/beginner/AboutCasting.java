...
public class AboutCasting {
    ...
    public void classCasting() {
        try {
            ...
            ((Sleepable) o).sleep(); // would this even compile without the cast?
                                    // no, it wouldnt compile without the cast.
                                    // unless were creating an object from child, parent or grandparent class
    ...
    public void complicatedCast() {
        ...
        // We can explicitly cast a Grandparent to a parent.
